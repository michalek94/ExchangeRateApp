...
public class ExchangeRateCell: UITableViewCell {
    ...
    private func setupLayout() {
        ...
        titleLabel.topToSuperview(offset: 22.5)
        titleLabel.leadingToSuperview(offset: 30.0)
        titleLabel.trailingToSuperview(offset: 30.0)
        titleLabel.setHugging(.init(200), for: .vertical)

        exchangeRateLabel.topToBottom(of: titleLabel, offset: 15.0)
        exchangeRateLabel.leading(to: titleLabel)
        exchangeRateLabel.bottomToSuperview(offset: -22.5)

        exchangeRateDateLabel.topToBottom(of: titleLabel, offset: 15.0)
        exchangeRateDateLabel.leadingToTrailing(of: exchangeRateLabel)
        exchangeRateDateLabel.trailing(to: titleLabel)
    ...
    public func setupCell(with viewModel: ExchangeRateCellViewModel?) {
        ...
        titleLabel.text = viewModel.exchangeRateCodeCurrencyName
