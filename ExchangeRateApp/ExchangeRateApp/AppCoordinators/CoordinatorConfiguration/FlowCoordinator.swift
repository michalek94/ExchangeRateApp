...
public class FlowCoordinator: NSObject {
    ...
    public func start(childCoordinator: FlowCoordinator) {
    ...
    public func handle(flowEvent: FlowEvent) -> Bool {
        return false
    }
...
extension FlowCoordinator: Coordinator {
    @objc open func start() { fatalError("start() method has to be overriden by FlowCoordinator subclass") }
